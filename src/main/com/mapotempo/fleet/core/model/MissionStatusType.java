...
public class MissionStatusType extends ModelBase implements MissionStatusTypeInterface {
    ...
    public String getSVGPath() {
        return getProperty(SVG_PATH, String.class, defaultSVG);
    }
